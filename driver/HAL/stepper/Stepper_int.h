...
#ifndef HAL_STEPPER_STEPPER_INT_H
#define HAL_STEPPER_STEPPER_INT_H

#define STEPPER_PORT DIO_PORTA

#define STEPPER_PINK DIO_PIN0
#define STEPPER_BLUE DIO_PIN1
#define STEPPER_YELLOW DIO_PIN2
#define STEPPER_ORANGE DIO_PIN3
...
#endif HAL_STEPPER_STEPPER_INT_H
